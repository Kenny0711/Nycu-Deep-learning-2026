    ...
    def inpainting(self,image,mask_b,i): #MakGIT inference
        ...
        with torch.no_grad():
            ...
            for step in range(self.total_iter):
                ...
                # masked_z_indices = z_indices_predict
...
#TODO3 step1-2: modify the path, MVTM parameters
    parser.add_argument('--load-transformer-ckpt-path', type=str, default='C:/Users/kenny/Downloads/best_model.pt/best_model.pt', help='load ckpt')
    ...
    print(f"Starting inpainting for {len(t.mi_ori)} images...")
    i=0
    ...
    print(f"Finished! Results saved in 'test_results/' folder.")