...
class kl_annealing():
    def __init__(self, args, current_epoch=0):
        ...
        if args.kl_anneal_type=='Cyclical':
            self.beta=self.frange_cycle_linear(args.num_epoch,0,1,n_cycle=args.kl_anneal_cycle,ratio=args.kl_anneal_ratio)
        elif args.kl_anneal_type=='Monotonic':
            self.beta=self.frange_cycle_linear(args.num_epoch,0,1,n_cycle=1,ratio=args.kl_anneal_ratio)
